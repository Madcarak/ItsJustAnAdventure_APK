...
function showScreen(id) {
    ...
    /* -----------------------------------------------------
         ✅ GESTION OBJET UNIQUE (onceFlag)
    ------------------------------------------------------ */
    if (item && screen.onceFlag) {

        if (player.flags && player.flags[screen.onceFlag]) {
...
"Ecran0000": {
  ...
  choix: [
    { texte: "Revenir au chapitre de la fôret", goto: "Ecran0001" },
...
"Ecran0005": {
  ...
  choix: [
    ...
    { texte: "Redescendre vet la forêt", goto: "Ecran0001" },
  ]
},
"Ecran0007": {
  titre: "Le panneau",
...
"Ecran0009": {
  ...
  choix: [
    { texte: "Continuer à travers bois", goto: "Ecran0004" },
    { texte: "Fouiller autour des tombes", goto: "Ecran0008" },
    { texte: "Retourner ers la forêt", goto: "Ecran0001" },
  ]
},
"Ecran0009A": {
  titre: "Recueillement",
...
"Ecran0017": {
  ...
  requiresMissingItem: "Bague maudite",
  alternateGotoIfOwned: "Ecran0005",
  choix: [
...
"Ecran0019": {
  titre: "L'Homme-Arbre",
  texte: "Je préfère ça ! Cela m'embêterai de devoir te maltraiter..",
  image: "Lieux/Foret/004. Foret.jpg",
  choix: [
    { texte: "Tu ne vas pas me manger tout de même ?", goto: "Ecran0012" },
...
"Ecran0041": {
  ...
  image: "Lieux/Foret/029. Foret.jpg",
  choix: [
    { texte: "Espèce de sale mollusque baveux, tu m'entends ?", goto: "Ecran0042" },
    { texte: "Poulpy !?", goto: "Ecran0042" },
  ]
},
"Ecran0042": {
  titre: "L'octopus",
...
"Ecran0089A": {
  ...
  choix: [
    { texte: "Prendre la pierre et quitter le tumulus", goto: "Ecran0013" },
  ]
},
"Ecran0089B": {
  titre: "Salle du trésor",
...
"Ecran0093": {
  titre: "Le pacte",
  texte: "« J’allumerai ta torche… mais j’ai besoin soit d'un parchemin elfique soit d'une glande lumineuse et d'un bout de bois bien sûr ! »",
  image: "Lieux/Foret/036. Foret.png",

  choix: [
    { texte: "Un parchemin elfique !", goto: "Ecran0093A" },
    { texte: "Une glande lumineuse", goto: "Ecran0093B" },
...
"Ecran0093B": {
  titre: "Allumer la torche à l'aide de la glande lumineuse",
  image: "Lieux/Foret/036. Foret.png",
