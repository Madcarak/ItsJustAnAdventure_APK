...
(1.65 Go) ** Clonez le projet ** et exécutez le localement à partir de ** cmd.exe ** ou ** powershell ** sous Windows :
-----------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------
(227 Mo) ** APK android ** disponible en version debug à cette emplacement en local :
-----------------------------------------------------------------------------------------------------
...
## 💡 Galerie des visuels alternés (PC et Mobile)
...
<table>
  <tr>
    <th align="center">🖥️ Visuels PC</th>
    <th align="center">📱 Visuels Mobile</th>
  </tr>
  ...
  <!-- Ligne 9 (Visuel Mobile seulement) -->
  <tr>
    <td align="center">—</td>
    <td align="center">
